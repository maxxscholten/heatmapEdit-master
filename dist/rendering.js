    ...
    function link(scope, elem, attrs, ctrl) {
        ...
        function addXAxis() {
            ...
            if (dashboardTimeZone === 'utc') {
                timeFormat = d3_1.default.utcFormat(grafanaTimeFormatter);
            }
            else {
                timeFormat = d3_1.default.timeFormat(grafanaTimeFormatter);
            }
        ...
        function addYAxis() {
            ...
            var flot_tick_size = ticks_1.getFlotTickSize(y_min, y_max, ticks, decimalsAuto);
            var scaledDecimals = ticks_1.getScaledDecimals(decimals, flot_tick_size);
        ...
        function addLogYAxis() {
            ...
            // Calculate scaledDecimals for log scales using tick size (as in jquery.flot.js)
            var flot_tick_size = ticks_1.getFlotTickSize(y_min, y_max, tick_values.length, decimalsAuto);
            var scaledDecimals = ticks_1.getScaledDecimals(decimals, flot_tick_size);
            ctrl.decimals = decimals;
            ctrl.scaledDecimals = scaledDecimals;
            data.yAxis = {
        ...
        function addHeatmap() {
            ...
            colorScale = color_scale_1.getColorScale(colorScheme, core_1.contextSrv.user.lightTheme, maxValue, minValue);
            opacityScale = color_scale_1.getOpacityScale(panel.color, maxValue);
            setCardSize();
