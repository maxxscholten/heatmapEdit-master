System.register(['app/plugins/sdk', 'lodash', 'app/core/utils/kbn', 'app/core/time_series2', './axes_editor', './display_editor', './rendering', './heatmap_data_converter'], function(exports_1) {
    var __extends = (this && this.__extends) || function (d, b) {
        for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
        function __() { this.constructor = d; }
        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
    };
    var sdk_1, lodash_1, kbn_1, time_series2_1, axes_editor_1, display_editor_1, rendering_1, heatmap_data_converter_1;
    var X_BUCKET_NUMBER_DEFAULT, Y_BUCKET_NUMBER_DEFAULT, panelDefaults, colorModes, opacityScales, colorSchemes, HeatmapCtrl;
    return {
        setters:[
            function (sdk_1_1) {
                sdk_1 = sdk_1_1;
        ...
        execute: function() {
            ...
            HeatmapCtrl = (function (_super) {
                ...
                HeatmapCtrl.prototype.onRender = function () {
                    ...
                    var _a = heatmap_data_converter_1.convertToCards(bucketsData), cards = _a.cards, cardStats = _a.cardStats;
                    this.data = {
                        buckets: bucketsData,
                ...
                HeatmapCtrl.prototype.parseSeries = function (series) {
                    ...
                    var minLog = lodash_1.default.min(lodash_1.default.map(series, function (s) { return s.stats.logmin; }));
                ...
                HeatmapCtrl.templateUrl = './partials/module.html';
                return HeatmapCtrl;
